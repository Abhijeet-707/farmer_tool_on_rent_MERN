  ...
  useEffect(() => {
    ...
    const fetchTools = async () => {
      try {
        ...
        setTools(res.data.filter(t => t.category.toLowerCase() === 'thresher' || t.category === 'થ્રેશર'));
      } catch (error) {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-[#e6fcf0]">
      ...
      <main className="flex-grow p-6 md:p-10 max-w-7xl mx-auto w-full">
        <div className="mb-8">
          <h1 className="text-3xl font-extrabold text-gray-900 mb-1">થ્રેશર</h1>
...
export default ThresherCategory;
