  ...
  return (
    <div className="min-h-screen flex flex-col font-sans bg-[#e6fcf0]">
      ...
      <main className="flex-grow p-6 md:p-10 max-w-7xl mx-auto w-full">
        <div className="mb-8">
          <h1 className="text-3xl font-extrabold text-gray-900 mb-1">બધા સાધનો</h1>
          <p className="text-gray-500 font-semibold text-lg drop-shadow-sm">અમારી પાસે ઉપલબ્ધ તમામ સાધનોની યાદી</p>
        </div>
            ...
            <div key={tractor.id} className="bg-white rounded-[2rem] shadow-sm border border-gray-100 flex flex-col overflow-hidden hover:shadow-md transition-all pt-6 p-4">
              ...
              <div className="px-4 flex flex-col flex-grow">
                <div className="flex justify-between items-start mb-1">
                  <h3 className="text-2xl font-black text-gray-900">{tractor.name}</h3>
                  <span className="text-xs font-bold text-gray-500 bg-gray-100 px-2 py-1 rounded-md">{tractor.category}</span>
                </div>
                <div className="flex items-center text-gray-500 mb-6 drop-shadow-sm mt-1">
